...
| Encrypt with password   | `python pylock.py file.txt --encrypt --password xyz` | `python pylock.py file.txt -e -p xyz`  | Provide password directly (not recommended)      |
| Decrypt with password   | `python pylock.py file.txt.pylock --decrypt -p xyz`  | `python pylock.py file.txt.pylock -d -p xyz` | Provide password directly (not recommended) |
